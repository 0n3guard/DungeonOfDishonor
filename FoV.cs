...
public class FoV
{
    ...
    {
        for (int y = 0; y < GameObject.Find("DungeonGenerator").GetComponent<DungeonGenerator>().mapHeight; y++)
        {
            for (int x = 0; x < GameObject.Find("DungeonGenerator").GetComponent<DungeonGenerator>().mapWidth; x++)
            {
    ...
    static List<Vector2Int> GetCellsAlongLine(Vector2Int origin, Vector2Int destination)
    {
        ...
        int mapWidth = GameObject.Find("DungeonGenerator").GetComponent<DungeonGenerator>().mapWidth;
        int mapHeight = GameObject.Find("DungeonGenerator").GetComponent<DungeonGenerator>().mapHeight;
